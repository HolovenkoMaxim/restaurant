(() => {
    ...
    function initSliders() {
        if (document.querySelector(".our-menu__slider.swiper")) new core(".our-menu__slider.swiper", {
        ...
        if (document.querySelector(".reviews__slider.swiper")) new core(".reviews__slider.swiper", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".our-chefs__slider.swiper")) new core(".our-chefs__slider.swiper", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    function headerScroll() {
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            const startPoint = greetings.offsetHeight - 100;
            clearTimeout(timer);
